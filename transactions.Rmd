---
title: "Fast_Analytics_with_data.table"
...
This project showcases how to perform fast, scalable analytics on large-scale transactional data using R's powerful data.table package. From exploratory data analysis to user segmentation (clustering), churn detection. This workflow is optimized for performance and insight generation.
